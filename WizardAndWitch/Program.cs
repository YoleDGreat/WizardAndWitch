...
namespace WizAndWitch
{
    public class Program
    {
        ...
        {
            string[] mainMenu = { "New Game", "Load Game", "Campaign","Credits", "Exit" };
        ...
        static void ShowStory()
        {
            ...
            string[] words2 = story3.Split(' ');
            string[] words1 = story2.Split(' ');
            ...
            foreach (char c1 in story2)
            {
                Console.Write(c1);
                Thread.Sleep(30);
            }

            foreach (char c3 in story3)
            {
                Console.Write(c3);
                Thread.Sleep(30);
            }
